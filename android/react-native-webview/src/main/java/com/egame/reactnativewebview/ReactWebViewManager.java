...
//            super.onReceivedHttpAuthRequest(webView, httpAuthHandler, s, s1);
    ...
    private static class ReactWebView extends WebView implements LifecycleEventListener {
        ...
        private class ReactWebViewBridge {
            ...
            ReactWebViewBridge(ReactWebViewManager.ReactWebView c) {
                mContext = c;
            }
        ...
        public void setMessagingEnabled(boolean enabled) {
            ...
            if (enabled) {
                addJavascriptInterface(new ReactWebViewManager.ReactWebView.ReactWebViewBridge(this), BRIDGE_NAME);
                linkBridge();
            } else {
    ...
    protected WebView createViewInstance(ThemedReactContext reactContext) {
        ...
        ReactWebViewManager.ReactWebView webView = new ReactWebViewManager.ReactWebView(reactContext);
    ...
    public void setInjectedJavaScript(WebView view, @Nullable String injectedJavaScript) {
        ((ReactWebViewManager.ReactWebView) view).setInjectedJavaScript(injectedJavaScript);
    }

    @ReactProp(name = "messagingEnabled")
    public void setMessagingEnabled(WebView view, boolean enabled) {
        ((ReactWebViewManager.ReactWebView) view).setMessagingEnabled(enabled);
    }
    ...
    protected void addEventEmitters(ThemedReactContext reactContext, WebView view) {
        ...
        view.setWebViewClient(new ReactWebViewManager.ReactWebViewClient());
    }
    ...
    public void onDropViewInstance(WebView webView) {
        ...
        ((ThemedReactContext) webView.getContext()).removeLifecycleEventListener((ReactWebViewManager.ReactWebView) webView);
    ...
    private void initWebSettings(WebView webView) {
        ...
        // 设置代理
//        WebViewProxySetting.setProxy(webView);
    }
    ...
    /*package*/ static void dispatchEvent(WebView webView, Event event) {
