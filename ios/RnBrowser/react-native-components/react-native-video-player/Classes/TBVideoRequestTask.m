...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(cancel) name:@"DisconnectedRequest" object:nil];
...
{
    NSLog(@"connnection ------> data is %lu",(unsigned long)data.length);
